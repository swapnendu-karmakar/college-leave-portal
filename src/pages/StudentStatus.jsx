                        ...
                        {!['approved', 'rejected'].includes(application.status.toLowerCase()) && (
                            <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-2xl border-2 border-blue-200 dark:border-blue-800/50">
                                ...
                                <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">
                                    You can upload additional proofs, medical certificates, or relevant documents here. Note: You cannot upload documents after a final decision has been made.
                                </p>
                                <FileUpload
